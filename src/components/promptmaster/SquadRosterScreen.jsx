...
const SQUAD = [
  ...
  {
    id:"THOMPSON",   rank:"PFC",  surname:"Thompson",   first:'James "Jimmy"',           origin:"West Virginia — coal country",         role:"Rifleman · Tunnel Volunteer", mos:"0311",  fireteam:"FT1", weapon:"M-16",            status:"KIA Ch.?? — spider hole/L-shape trap", statusColor:"text-red", kia:true,
    notes:"Death: spider hole / L-shaped tunnel trap. Chapter TBD — author's call. Overconfidence + random = Vietnam in microcosm.",
    address:"'Thompson' · 'Jimmy' · uses 'all y'all'",
    colorClass:"text-orange",
  },
  {
