...
Deno.serve(async (req) => {
  ...
  if (manuscriptChange) {
    ...
    // BASE44_APP_ID is set automatically in the function runtime; falls back to the hardcoded app id.
    const appId = Deno.env.get('BASE44_APP_ID') || '69cc495ef72e0f794cb78a95';
    const uploadRes = await fetch(
      `https://api.base44.com/api/apps/${appId}/integrations/Core/UploadFile`,
