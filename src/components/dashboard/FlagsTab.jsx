...
const SEV_CONFIG = {
  ...
  RETIRED:  { color: "muted-foreground", bg: "bg-secondary/30", border: "border-border"  },
};
    ...
    <div className="animate-slide-up space-y-4">
      ...
      <DashCard title={`Chapter Bugs — ${filter === "ALL" ? "All" : filter} (${bugs.length})`} accent="red">
        <div className="space-y-2">
          {bugs.map((b, i) => {
            const cfg = SEV_CONFIG[b.sev] || { color: "muted-foreground", bg: "bg-secondary/30", border: "border-border" };
            return (
