...
import BattleScenesTab from "../components/dashboard/BattleScenesTab";
import OmegaCLSTrendTab from "../components/dashboard/OmegaCLSTrendTab";
import DriveSyncStatus from "../components/dashboard/DriveSyncStatus";
import MarketingCalendarTab from "../components/dashboard/MarketingCalendarTab";
import ClaimsLedgerTab from "../components/dashboard/ClaimsLedgerTab";
import DuplicationMapTab from "../components/dashboard/DuplicationMapTab";
import ExecutiveDecisionTab from "../components/dashboard/ExecutiveDecisionTab";

export default function Dashboard() {
  const navigate = useNavigate();
  const { activeTab, showExport, setShowExport } = useAppContext();

  const renderTab = () => {
    switch (activeTab) {
      case "overview":    return <OverviewTab />;
      case "chapters":    return <ChaptersTab />;
      case "domains":     return <PlaceholderTab name="DOMAINS" />;
      ...
      case "battle":        return <BattleScenesTab />;
      case "omegacls":    return <OmegaCLSTrendTab />;
      case "mktcal":      return <MarketingCalendarTab />;
      case "claims":      return <ClaimsLedgerTab />;
      case "dupmap":      return <DuplicationMapTab />;
      case "execboard":   return <ExecutiveDecisionTab />;
  ...
  return (
    <div className="min-h-full bg-background font-sans">
      <div className="max-w-[1440px] mx-auto px-4 md:px-6 pt-2 pb-0">
        <DriveSyncStatus />
      </div>
      <main className="max-w-[1440px] mx-auto px-4 md:px-6 py-4">
